...
void ContainerWidget::createPlaybackButtons()
{
    ...
    (
        "QPushButton {"
        "   image: url(:/playback/playback/left chevron.png);"
        "   background-color: transparent;"
        "   border: none;"
        "   outline: none;"
        "}"
        "QPushButton:hover {"
        "   image: url(:/playback/playback/left chevron hover.png)"
        "}"
    );
    ...
    (
        "QPushButton {"
        "   image: url(:/playback/playback/play.png);"
        "   background-color: transparent;"
        "   border: none;"
        "   outline: none;"
        "}"
        "QPushButton:hover {"
        "   image: url(:/playback/playback/play hover.png)"
        "}"
        "QPushButton:checked {"
        "    image: url(:/playback/playback/pause.png);"
        "}"
        "QPushButton:checked:hover {"
        "    image: url(:/playback/playback/pause hover.png);"
        "}"
    );
    ...
    (
        "QPushButton {"
        "   image: url(:/playback/playback/right chevron.png);"
        "   background-color: transparent;"
        "   border: none;"
        "   outline: none;"
        "}"
        "QPushButton:hover {"
        "   image: url(:/playback/playback/right chevron hover.png)"
        "}"
    );
...
QLabel* ContainerWidget::createStrings(QString note)
{
...
void ContainerWidget::createFretBoard()
{
...
void ContainerWidget::createPlayingTechniqueButtons()
{
...
QWidget *ContainerWidget::createTempoButton()
{
...
void ContainerWidget::addChord(QVector<int> chord)
{
    tab->addChord(chord);
}
...
QScrollArea *ContainerWidget::createScrollArea()
{
    ...
    (
        ...
        "    width: 8px;"
        "    height: 8px;"
        "    image: url(:/scroll/scroll/scroll up.png);"
        "}"
